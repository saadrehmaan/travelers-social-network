...
class EditPlan extends Component {
    ...
    firestorePlansRef = firebase.firestore().collection("plans").doc(this.props.navigation.getParam('plan').id);
    ...
    removeSpot = (place_id)=>{
      ...
      getCurrentDate = ()=>{
        ...
        getProfilePic = () =>{
            ...
            const firebaseProfilePic = firebase.storage().ref().child("profilePics/("+creatorId+")ProfilePic");
    ...
    render() {
        return (
            ...
            {/* 2 free */}
            <Block flex={1}><Text h4>Spots</Text></Block>
            <Block flex={7}>
            <View style={{ height: 140, marginTop: 5 }}>
                                ...
                                >
                                    ...
                                    <Category 
                                        imageUri={place.photos==""?"https://media-exp1.licdn.com/dms/image/C560BAQHMnA03XDdf3w/company-logo_200_200/0?e=2159024400&v=beta&t=C7KMOtnrJwGrMXmgIk2u1B8a7VRfgxMwXng9cdP9kZk":place.photos[0]}
                                        name={place.name}
                                        // friend={false}
                                    />
                                    </TouchableOpacity>

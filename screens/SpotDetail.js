...
class SpotDetail extends Component {
    ...
    addSpot = ()=>{
        ...
        params.addSpot(this.state.place_id, this.state.name, this.state.location, this.state.spotStartDateTime, this.state.spotEndDateTime, this.state.images);
    ...
    renderImages = ()=>{
        return(
            ...
            <Block shadow flex={4} style={{backgroundColor: '#f5f5f5', borderRadius: 2, marginBottom: 2 , width:width*0.9}}>
            ...
            <Block center flex={0.8} width={width * 0.8} style={{ marginBottom: 15 }}>
            <DatePicker
                            style={{width: 200}}
                            ...
                            onDateChange={(date) => {this.setState({spotStartDateTime: date})}}
                        />
                    </Block>
            ...
            <DatePicker
                        ...
                        onDateChange={(date) => {this.setState({spotEndDateTime: date})}}
                        />
                    </Block>
                    }
            ...
            <Block center flex={1} style={{marginTop: 2, paddingTop: 5}}>
                {!this.state.added&&
                <Button  round size="small"  color="#ff6347" shadowless onPress={this.addSpot} >Add to Plan</Button>
            }
                {this.state.added&&
                <Button  round size="small"  color="#ff6347" shadowless onPress={this.removeSpot} >Remove</Button>
            }
                </Block>
            </Block>

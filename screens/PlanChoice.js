...
class PlanChoice extends Component {
    ...
    render() {
        return (
            ...
            <Block shadow flex style={{backgroundColor: '#f5f5f5', borderRadius: 2, marginBottom: 2 , width:width*0.9}}>
            ...
            <Block center flex={1} style={{marginTop: 2, paddingTop: 5}}>
                <Button  round size="small"  color="#ff6347" shadowless onPress={()=>{alert("Feature coming soon!")}} >Recommended Plan</Button>
            </Block>
            <Block center flex={1} style={{marginTop: 2, paddingTop: 5}}>

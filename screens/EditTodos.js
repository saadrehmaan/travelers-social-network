   ...
   return(
    ...
    this.state.todos.map((todo, i) => {
            ...
            <Block left row key={i}>
                <Block row left>
                   {todo.checked&&
                    <Checkbox initialValue={true} color="warning" onChange={() => {this.toggleCheck(todo.todo)}} label="" checkboxStyle={{marginTop: 12}} />
                }
                   {!todo.checked&&
                    <Checkbox initialValue={false} color="warning" onChange={() => {this.toggleCheck(todo.todo)}} label="" checkboxStyle={{marginTop: 12}} />
                }
                    <ListItem
                    ...
                    <Block right>
                        <Button onlyIcon icon="minuscircle" iconFamily="antdesign" iconSize={20} color="#f5f5f5" iconColor="tomato" style={{ width: 30, height: 30, marginTop:8 }} onPress={()=>{this.removeTodo(todo)}}></Button>
                    </Block>
    ...
    {this.state.todos.length>0&&
        ...
        <Button  round size="small"  color="tomato" onPress={()=>{
  ...
  renderSearchBar=()=>{
    ...
    return (
        <Block row flex style={styles.inputContainer}>
            ...
            <Block right flex={1}>
            <Button onlyIcon icon="pluscircle" iconFamily="antdesign" iconSize={25} color="#f5f5f5" iconColor="#fff" style={{ width: 30, height: 30, marginTop:12, marginRight:8 }} onPress={this.addTodo}></Button>
            </Block>

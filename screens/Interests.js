...
//   .collection("userPosts");
  ...
  state = {
    ...
    items:[
        {name: "Photography", id:1, selected:false, iconName:'camera', iconFamily:'EvilIcons', color:'tomato'},
        {name: "Research", id:2, selected:false, iconName:'location', iconFamily:'EvilIcons', color:'#3FA7D6'},
        {name: "Music", id:3, selected:false, iconName:'customerservice', iconFamily:'Antdesign', color:'#8EE269'},
        {name: "Vlogs", id:4, selected:false, iconName:'videocamera', iconFamily:'AntDesign', color:'#9B77F3'},
        {name: "Tech", id:5, selected:false, iconName:'laptop', iconFamily:'antdesign', color:'#F5C851'},
        {name: "Food", id:6, selected:false, iconName:'drink', iconFamily:'Entypo', color:'#FAC05E'},
        {name: "Parks", id:7, selected:false, iconName:'light-up', iconFamily:'Entypo', color:'#8EE269'},
        {name: "Cafes", id:8, selected:false, iconName:'rest', iconFamily:'AntDesign', color:'#3FA7D6'},
        {name: "Beauty", id:9, selected:false, iconName:'basecamp', iconFamily:'Entypo', color:'#FF5964'},
        {name: "Books", id:10, selected:false, iconName:'book', iconFamily:'Entypo', color:'#F06543'},
        {name: "Cars", id:11, selected:false, iconName:'car', iconFamily:'AntDesign', color:'#E01A4F'},
        {name: "Movies", id:12, selected:false, iconName:'folder-video', iconFamily:'Entypo', color:'#F9C22E'},
        {name: "Education", id:13, selected:false, iconName:'book', iconFamily:'AntDesign', color:'#53B3CB'},
        {name: "Shopping", id:14, selected:false, iconName:'gift', iconFamily:'AntDesign', color:'#809FFC'},
        {name: "Sports", id:15, selected:false, iconName:'dribbble', iconFamily:'Entypo', color:'#8EE269'},
...
getInterests = () =>{
  this.firestoreUserRef.get().then((doc)=>{
    if(doc.data().interested){
      ...
      this.setState({items: doc.data().interests, interestsCompleted: true, itemCount: interestsArr.length});
...
return interestsArr;
 ...
 storeToken = async() => {
  ...
  renderInterests = ()=>{
   ...
   return(
       <SafeAreaView>
        <Block center shadow style={{width: width*0.9, backgroundColor:'#f5f5f5', borderRadius:5}}>
        <FlatList 
  ...
  renderSearchBar=()=>{
    ...
    return (
        <Block row flex style={styles.inputContainer}>
            ...
            <Block right flex={1}>
            <Button onlyIcon icon="pluscircle" iconFamily="antdesign" iconSize={25} color="#f5f5f5" iconColor="#fff" style={{ width: 30, height: 30, marginTop:12, marginRight:8 }}></Button>
            </Block>
  ...
  render() {
    ...
    return (
        <Block flex center>
            ...
            <Button round style={{width: width*0.7}} color="tomato" onPress={this.onUpdate}>Update</Button>
            </Block>
